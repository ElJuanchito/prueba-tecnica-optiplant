 ...
 * reachable path is dead contract (design §3.4). Product- and unit-level
 * exceptions arrive with slices S4–S6; only the category mappings that exist so
 * far are wired here.
 *
...
class CatalogExceptionHandler {
	 ...
	 * concurrent duplicate name racing {@code uq_categories_name_ci}. Only a
